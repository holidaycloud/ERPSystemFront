...
router.get('/customer/score/detail',cusAction.scoreDetail);
router.post('/customer/score/save',cusAction.saveScoreConfig);
//WeiXin
...
router.get('/wx/goAutoRes',wxAction.goAutoRes);
